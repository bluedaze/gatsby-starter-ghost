...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `http://animated-granita-cd715d.netlify.app`
            : `http://animated-granita-cd715d.netlify.app`, // Site domain. Do not include a trailing slash!
